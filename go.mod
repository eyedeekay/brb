...
require (
	...
	github.com/prologic/eris v1.6.7-0.20201114221618-690655d8e091 // indirect
...
replace github.com/khlieng/dispatch v0.6.4 => github.com/eyedeekay/dispatch v0.6.5-0.20201207172133-2e48554b26c3
